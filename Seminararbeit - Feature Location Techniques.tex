...
\tikzstyle{table} = [rectangle, text width=20em, text centered, rounded corners]
...
\input{src/tex/freemind_example}

\input{src/tex/basic_underlying_techniques}

\input{src/tex/classification_methodology}

\input{src/tex/feature_location_techniques}
